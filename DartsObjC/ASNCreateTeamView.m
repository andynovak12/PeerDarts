...
-(void)updateUI {
    ...
    if (self.team.players.count == 0) {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            self.p3Label.hidden = YES;
            self.p4Label.hidden = YES;
            self.p1AddButton.hidden = NO;
            self.p2AddButton.hidden = YES;
            self.p3AddButton.hidden = YES;
            self.p4AddButton.hidden = YES;
        });
    }
    else if (self.team.players.count == 1) {
        dispatch_async(dispatch_get_main_queue(), ^{
    ...
    else if (self.team.players.count == 2) {
        dispatch_async(dispatch_get_main_queue(), ^{
    ...
    else if (self.team.players.count == 3) {
        dispatch_async(dispatch_get_main_queue(), ^{
    ...
    else if (self.team.players.count == 4) {
        dispatch_async(dispatch_get_main_queue(), ^{
